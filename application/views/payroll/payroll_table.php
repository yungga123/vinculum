                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" name="cutoff_filter_start" id="cutoff_filter_start" required value="<?php if ($this->uri->segment(1) == 'payroll-filter') {
                                                                                                                                                        echo $start_date;
                                                                                                                                                    } ?>">
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" name="cutoff_filter_end" id="cutoff_filter_end" required value="<?php if ($this->uri->segment(1) == 'payroll-filter') {
                                                                                                                                                    echo $end_date;
                                                                                                                                                } ?>">
                                    </div>
                                </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card">
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="<?php echo site_url('payroll-delete/' . $row->payroll_id) ?>" class="btn btn-danger btn-xs" onclick="return confirm('Delete this payroll?')"><i class="fas fa-trash"></i></a>
                        ...
                        <div class="card-footer">
                        <a href="<?php echo site_url('payroll-exportitems/').$start_date. '/'.$end_date ?>" class="btn btn-success text-bold" target="_blank"><i class="fas fa-print"></i> Export</a>
