...
<div class="modal fade modal_form_error" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
		...
		<div class="modal-content">
			<div class="modal-body">
				...
				<div class="form-group">
					<div class="row">
						<div class="col-sm-12">
							<button type="submit" class="btn btn-danger btn-block text-bold" onclick="window.close()"><i class="fas fa-times"></i> CLOSE</button>
						</div>
					</div>
				</div>
			</div>
