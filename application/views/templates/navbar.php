...
<!-- Navbar -->
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="#" class="brand-link">
      <img src="<?php echo base_url('assets/images/') ?>vcmlogo.jpg" alt="Vinculum Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      	...
      	<nav class="mt-2">
			...
			<li class="nav-item has-treeview<?php echo $requisition_tree ?>">
				...
				<ul class="nav nav-treeview" style="display: <?php echo $requisition_display ?>">
					...
					<li class="nav-item">
						<a href="<?php echo site_url('inquiry-tempo-clients') ?>" class="nav-link <?php echo $requisition_pending ?>">
							<i class="far fa-circle nav-icon"></i>
