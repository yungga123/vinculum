		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			...
			<div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
						...
						<!-- INVENTORY GROUP -->
						<li class="nav-item has-treeview <?php echo $inventory_menu_status; ?>">
							...
							<ul class="nav nav-treeview">
								...
								<li class="nav-item has-treeview<?php echo $prf_menu_status ?>">
									<a href="javascript:void(0)" class="nav-link<?php echo $ul_prf ?>">
										<i class="nav-icon nav-icon fab fa-wpforms"></i>
										<p>
											PRF
											<i class="fas fa-angle-left right"></i>
										</p>
