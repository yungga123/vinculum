...
if ($this->session->userdata('add')) {
    ...
    foreach ($edit_project as $row) {
        $project_data_result = [
            ...
            'project_details_edit' => $row->project_details,
            'project_amount_edit' => $row->project_amount,
            'project_quotation_ref_edit' => $row->quotation_ref,
            'date_of_installation_edit' => $row->date_of_installation
        ];
    }
                ...
                <div class="col-sm-12">
                    <div class="card">
                        ...
                        <?php if ($this->session->userdata('add')) : ?>
                                ...
                                <div class="col-sm-12">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            ...
                                            <div class="form-group">
                                                <p>
                                                    ...
                                                    <input type="text" name="project_details" class="form-control" placeholder="Enter Project Details">
                                                </p>
                                            </div>
                                            <div class="form-group">
                                                <p>
                                                    <label for="project">Project Amount</label>
                                                    <input type="text" name="project_amount" class="form-control" placeholder="Enter Project Amount">
                                                </p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6">
                                                ...
                                                <p>
                                                    ...
                                                    <select id="project_sales_incharge" name="project_sales_incharge" class="form-control">
                                                        ...
                                                        <?php foreach ($results as $row) : ?>
                                                            <?php if ($row->id == "01021415" || $row->id == "PTS09092020" || $row->id == "02021415" || $row->id == "24120518" || $row->id == "PS021021" || $row->id == "SEO041921" || $row->id == "SSC091321") : ?>
                                            ...
                                            <div class="form-group">
                                                <p>
                                                    <label for="project">Quotation Reference Number</label>
                                                    <input type="text" name="quotation_ref" class="form-control" placeholder="Enter Project Amount">
                                                </p>
                                            </div>
                                            <div class="form-group">
                                                <label for="date_of_installation">Date of Installation</label>
                                                <div class="input-group">
                                                    <input class="form-control" type="date" name="date_of_installation" placeholder="Select Date">
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="card-footer">
                                <div class="row float-right">
                                    <button type="submit" class="btn btn-success btn-sm"> <i class="fas fa-plus"></i> Add Project</button>
                                </div>
                            </div>
                            <?php echo form_close() ?>
                        <?php elseif ($this->session->userdata('edit')) : ?>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <p>
                                                    ...
                                                    <select name="project_branch" class="form-control">
                                                        <option value="">Please Select Branch Name</option>
                                                        <?php foreach ($branch_list as $row) : ?>
                                                            <option value="<?php echo $row->branch_id ?>" <?php if ($project_branch_result['project_branch_id'] == $row->branch_id) {
                                                                                                                echo 'selected';
                                                                                                            } ?>>
                                                                <?php echo $row->branch_name ?>
                                                            </option>
                                            ...
                                            <div class="form-group">
                                                <p>
                                                    ...
                                                    <select name="project" class="form-control">
                                                        <option value="">---Please Select---</option>
                                                        <option <?php if ($project_data_result['project_type_edit'] == "CCTV") {
                                                                    echo 'selected';
                                                                } ?>>CCTV</option>
                                                        <option <?php if ($project_data_result['project_type_edit'] == "ACS") {
                                                                    echo 'selected';
                                                                } ?>>ACS</option>
                                                        <option <?php if ($project_data_result['project_type_edit'] == "Time Attendance") {
                                                                    echo 'selected';
                                                                } ?>>Time Attendance</option>
                                                        <option <?php if ($project_data_result['project_type_edit'] == "Gate Barrier") {
                                                                    echo 'selected';
                                                                } ?>>Gate Barrier</option>
                                                        <option <?php if ($project_data_result['project_type_edit'] == "PABX") {
                                                                    echo 'selected';
                                                                } ?>>PABX</option>
                                                        <option <?php if ($project_data_result['project_type_edit'] == "PABGM") {
                                                                    echo 'selected';
                                                                } ?>>PABGM</option>
                                                        <option <?php if ($project_data_result['project_type_edit'] == "E-Fence") {
                                                                    echo 'selected';
                                                                } ?>>E-Fence</option>
                                                        <option <?php if ($project_data_result['project_type_edit'] == "Home Alarm") {
                                                                    echo 'selected';
                                                                } ?>>Home Alarm</option>
                                                        <option <?php if ($project_data_result['project_type_edit'] == "Video Intercom") {
                                                                    echo 'selected';
                                                                } ?>>Video Intercom</option>
                                                        <option <?php if ($project_data_result['project_type_edit'] == "Structured Cabling") {
                                                                    echo 'selected';
                                            ...
                                            <div class="form-group">
                                                <p>
                                                    <label for="project">Project Details</label>
                                                    <input type="text" name="project_details" class="form-control" placeholder="Enter Project Details" value="<?php echo $project_data_result['project_details_edit'] ?>">
                                                </p>
                                            </div>
                                            <div class="form-group">
                                                <p>
                                                    <label for="project">Project Amount</label>
                                                    <input type="text" name="project_amount" class="form-control" placeholder="Enter Project Amount" value="<?php echo number_format($project_data_result['project_amount_edit'], 2) ?>">
                                                </p>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <p>
                                                    ...
                                                    <select name="project_status" class="form-control">
                                                        <option value="">---Please Select---</option>
                                                        <option value="50%" <?php if ($project_data_result['project_status_edit'] == "50%") {
                                                                                echo 'selected';
                                                                            } ?>>50% --- Developing Solution</option>
                                                        <option value="70%" <?php if ($project_data_result['project_status_edit'] == "70%") {
                                                                                echo 'selected';
                                                                            } ?>>70% --- Evaluation</option>
                                                        <option value="90%" <?php if ($project_data_result['project_status_edit'] == "90%") {
                                                                                echo 'selected';
                                                                            } ?>>90% --- Negotiation</option>
                                                        <option value="100%" <?php if ($project_data_result['project_status_edit'] == "100%") {
                                                                                    echo 'selected';
                                                                                } ?>>100% --- Booked</option>
                                                    </select>
                                                </p>
                                                ...
                                                <p>
                                                    ...
                                                    <select name="project_sales_incharge" class="form-control">
                                                        <?php foreach ($edit_sales_list as $row) : ?>
                                                            <?php if ($row->id == "01021415" || $row->id == "PTS09092020" || $row->id == "02021415" || $row->id == "24120518" || $row->id == "PS021021" || $row->id == "SSC091321") : ?>
                                                                <option value="<?php echo $row->id ?>" <?php if ($project_data_result['project_sales_edit'] == $row->id) {
                                                                                                            echo 'selected';
                                                                                                        } ?>>
                                                                    <?php echo $row->id . " -- " . $row->lastname . ", " . $row->firstname . " " . $row->middlename  ?>
                                                                </option>
                                            ...
                                            <div class="form-group">
                                                <p>
                                                    <label for="project">Quotation Reference Number</label>
                                                    <input type="text" name="quotation_ref" class="form-control" placeholder="Enter Project Amount" value="<?php echo $project_data_result['project_quotation_ref_edit'] ?>">
                                                </p>
                                            </div>
                                            <div class="form-group">
                                                <label for="vendor_date">Date of Installation</label>
                                                <div class="input-group">
                                                    <input class="form-control" type="date" name="date_of_installation" placeholder="Select Date" value="<?php echo $project_data_result['date_of_installation_edit'] ?>">
                                                </div>
                                            </div>
                                    ...
                                    <?php foreach ($edit_task as $row) : ?>
                                        ...
                                        <div class="row add-task">
                                            ...
                                            <div class="col-sm-1">
                                                ...
                                                <div class="form-check">
                                                    <label class="form-check-label">
                                                        <input type="checkbox" class="form-check-input others" name="remarks[]" <?php if ($row->mark_as_read == 1) {
                                                                                                                                    echo 'checked';
                                                                                                                                } ?>>
                                                        Mark As Done
                                                    </label>
                            ...
                            <div class="card-footer">
                                <div class="row float-right">
                                    <button type="submit" class="btn btn-success btn-sm"> <i class="fas fa-edit"></i> <?php echo $button_title ?></button>
                                </div>
                            </div>
                            <?php echo form_close() ?>
                        <?php endif ?>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label for="branch_contact_person" class="control-label">Branch Contact Person</label>
                            <input type="text" name="branch_contact_person" class="form-control" placeholder="Enter Branch Personnel">
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label for="branch_contact_number" class="control-label">Branch Contact Number</label>
                            <input type="text" name="branch_contact_number" class="form-control" placeholder="Enter Branch Contact Number">
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    <label for="project_address" class="control-label">Branch Address</label>
