                ...
                <div class="row">
                    <div class="col-sm-3">
                        <div class="card">
                            ...
                            <div class="card-body">
                            <a href="<?php echo site_url('prf-list') ?>/pending" class="btn btn-warning text-bold btn-xl btn-block <?php if ($this->uri->segment(2) == 'pending') {echo 'disabled';} ?>"><i class="fas fa-pause"></i> Pending PRF</a>
...
<div class="modal fade" id="file-prf" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
        <?php if($this->uri->segment(2) == "ongoing"){$title = 'File PRF'; $title_text = 'File'; } else{$title = 'Pullout PRF'; $title_text = 'Pullout'; } ?>
            ...
            <div class="modal-body text-center">
                <div class="form-group">
                  ...
                  <input type="hidden" name="prf_status"value="<?php if($this->uri->segment(2) == "pending"){echo 'ongoing';} elseif($this->uri->segment(2) == "ongoing"){echo 'filed';} ?>">
