...
<body>
    ...
    <div class="row">
        <div class="col-sm-2">
        <img src="<?php echo ('http://192.168.0.90/qr_image/'.$approved_year."".$leave_id."".$approved_month."".$approved_day.'.png') ?>" alt="qrlogo" class="img-thumbnail sm-4" style="height: 150px;width: 170px">
        </div>
