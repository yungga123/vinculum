                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table id="tools_pullout" class="table table-bordered table-hover" style="width: 100%">
                                ...
                                <tbody>
                                    <tr>
                                        <?php if (count($results_tools_pullout) != 0) { ?>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
                <div class="form-group">
                    ...
                    <input type="text" name="tool_code" id="tool_code" class="form-control text-center" placeholder="">
                </div>

                <div class="form-group">
                    <label for="assigned_to">Assigned To</label>
                    <select name="assigned_to" id="assigned_to" class="form-control text-center">
                ...
                <div class="form-group">
                    ...
                    <select name="customer" id="customer" class="form-control text-center">
                        <option value="">--- Please Select ---</option>
