                ...
                <tbody>
					<tr class="text-center">
                        <td style="font-weight: bold">PURCHASE ORDER NO.
                            <br>
                            F06-<?php echo $supplier_data['vendor_category'] ?>-<?php echo $supplier_data['vendor_acronym'] ?>-<?php echo $po_data['po_date_year'] ?>-<?php echo $po_data['po_date_month'] ?><?php echo $po_data['po_date_day'] ?>-00
                        </td>
					</tr>
					<br>
					<tr class="text-center">
